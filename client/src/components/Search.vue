<template>
   <form @input="handleSearch" class="hidden md:block ml-16 lg:flex bg-white border-4 -space-x-px rounded-md max-w-xl flex-1 shadow-sm items-center relative">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="20" height="20" :class="!useLayoutStore.projectDropdown ? 'block' : 'hidden'" class="icon opacity-50 z-10 left-2 absolute ">
