<template>
   <form @input="handleSearch" class="ml-12 bg-white border-4 -space-x-px rounded-md flex max-w-xl flex-1 shadow-sm items-center relative">
...
<input v-model="search" placeholder="Search Products..." type="text" class="bg-white rounded-md font-medium border-gray-300 text-sm w-full p-2 pl-10 text-gray-500 z-0 inline-flex items-center"/>
    </form>
